...
namespace HRSystem.Controllers
{
    public class SalaryReportController : Controller
    {
        ...
        public SalaryReportController(IEmployeeRepositry employeeRepo, IAttendanceRepository attendanceRepo, IGeneralSettingRepository generalSettingRepo)
        {
        ...
        public IActionResult Index()
        {
            ...
            foreach (Employee employee in employees)
            {
                ...
                salRebVM.AbsenceDays = (DaysOfMonth - (salRebVM.Attendancedays + countOfweekRestOfMonth));
        ...
        public IActionResult Details(int id)
        {
            ...
            salaryReportViewModel.AbsenceDays = (DaysOfMonth - (salaryReportViewModel.Attendancedays + countOfweekRestOfMonth));
